...
1. **Términos de interacción:** ¿El efecto de la edad depende del potencial? Podríamos probar `age * potential`.

2. **No-linealidad:** Incluir términos cuadráticos (ej. `age + age²`) para capturar el efecto no lineal de la edad.

3. **Modelos de aprendizaje automático:** Random forests, gradient boosting, redes neuronales podrían mejorar el poder predictivo.

4. **Análisis de segmentos:** Construir modelos separados para delanteros, defensas, porteros, ya que pueden tener dinámicas de valoración diferentes.

5. **Series temporales:** Analizar cómo ha cambiado el valor de los jugadores a lo largo de diferentes versiones de FIFA.
...
- Dataset: FIFA 23 Players Data (Kaggle/SoFIFA)
- Paquetes de R: `tidyverse`, `car`, `ggplot2`
- Teoría: Apuntes del curso Métodos Lineales, ITAM
